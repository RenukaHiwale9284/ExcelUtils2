...
public class ExcelWorkbookTest {
    ...
    @Test
    void testCreateExcelSheet() throws ExtensionNotValidException, IOException, OpenWorkbookException, SheetAlreadyExistsException {
    	
    	 ExcelWorkbook excelWorkbook = ExcelWorkbook.open(excelFile);
         ExcelSheet excelSheet = excelWorkbook.createSheet("TestSheet");
         Assertions.assertNotNull(excelSheet.getSheet());
         Assertions.assertEquals("TestSheet", excelSheet.getName());
    }
    ...
    void countSheets() throws OpenWorkbookException, ExtensionNotValidException, IOException {
    	//err
        ExcelWorkbook excelWorkbook = ExcelWorkbook.open(excelFile);
        Assertions.assertEquals(9, excelWorkbook.countSheets());
    }
    ...
    void getSheets() throws OpenWorkbookException, ExtensionNotValidException, IOException {
        ...
        Assertions.assertEquals("Employee", excelSheets.get(1).getName());
        Assertions.assertEquals("Office", excelSheets.get(2).getName());
    }
    ...
    void getSheet() throws OpenWorkbookException, ExtensionNotValidException, IOException, SheetNotFoundException {
    	...
    	//
    	ExcelWorkbook excelWorkbook = ExcelWorkbook.open(excelFile);
        Assertions.assertEquals("Employee", excelWorkbook.getSheet(1).getName());
    }
    ...
    void testIsSheetPresent() throws OpenWorkbookException, ExtensionNotValidException, IOException {
      //
    	ExcelWorkbook excelWorkbook = ExcelWorkbook.open(excelFile);
        Assertions.assertEquals(true, excelWorkbook.isSheetPresent(8));
    }

    @Test
    void isSheetNull() throws OpenWorkbookException, ExtensionNotValidException, IOException {
        ExcelWorkbook excelWorkbook = ExcelWorkbook.open(excelFile);
        Assertions.assertEquals(false, excelWorkbook.isSheetNull("Sheet3"));
    }
...
//
    	ExcelWorkbook excelWorkbook = ExcelWorkbook.open(excelFile);
        Assertions.assertEquals(false, excelWorkbook.isSheetNull(8));
    }
